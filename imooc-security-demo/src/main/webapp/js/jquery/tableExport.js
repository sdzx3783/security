  ...
  $.fn.extend({
    tableExport: function (options) {
      ...
      if ( defaults.type == 'csv' || defaults.type == 'tsv' || defaults.type == 'txt' ) {
        ...
        if(defaults.exportDataType == 'all' && MSDocType == 'excel'){
        	console.log('export all data!');
        	var columnTitles = JSON.stringify(GetColumnTitles(defaults.columns));
        	var exportParams = $.extend({},{columnTitles: columnTitles, exportDocType: MSDocType},defaults.exportParams)
        	
        	DownLoadFile({
        		url: defaults.exportUrl,
        		data: exportParams
        	})
        }else{
      ...
      */
      ...
      function GetColumnTitles(columnData){
    	  var result=[];
    	  $(columnData).each(function(colIndex){
    		  result[colIndex]=columnData[colIndex].title;
    	  });
    	  return result;
      }
     ...
     function DownLoadFile(options) {
    	    ...
    	    $head.append($meta);
    	    $iframe.append($head).append($body);
